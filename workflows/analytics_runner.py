...
from workflows.analytics_pipeline.allergy_metrics import run_allergy_analytics
...
async def analytics_runner():
    with get_spark_session() as spark:
        async with get_supabase_client() as supabase:
            ...
            print("Running Allergy Analytics...")
            await run_allergy_analytics(spark=spark, supabase=supabase)
